...
python %ASCIIDOCDIR%asciidoc.py -o %DOCDIR%documentation_utilisateur_OptiWeb.html %SRCDOCDIR%docUtilisateur.txt
python %ASCIIDOCDIR%asciidoc.py -o %DOCDIR%documentation_technique_OptiWeb.html %SRCDOCDIR%docTechnique.txt
