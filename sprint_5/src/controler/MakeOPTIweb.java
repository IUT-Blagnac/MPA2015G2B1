...
public class MakeOPTIweb {
	...
	public static String writeHTMLInt(){
		...
		Intervenants intervenants = new Intervenants(new Projets(new Etudiants(new Encadrer()), new Encadrer()), new Encadrer());
	...
	public static String writeJSONInt(){
			...
			Intervenants inter = new Intervenants(new Projets(new Etudiants(new Encadrer()), new Encadrer()), new Encadrer());
