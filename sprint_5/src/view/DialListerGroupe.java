 ...
 * @version sprint_2
 */
public class DialListerGroupe extends JDialog implements ActionListener{
	...
	* @version sprint_2
	*/
	public DialListerGroupe(FenetrePrincipal fenetre, Groupe groupe){
		super(fenetre, "Liste des groupe", true);
...
////////////////////////////////Listener////////////////////////////////////////
	...
	public void update(){
		...
		ArrayList<String[]> allGroupeAffichage = groupe.getAllGroupe();
		
		for(int i = 1; i < allGroupeAffichage.size(); i++){
			Object[] contenue = allGroupeAffichage.get(i);
