 ...
 * @version sprint_2
 */
public class DialModifierEtudiant extends JDialog implements ActionListener{
	
	private static final long serialVersionUID = -3972917529655484426L;
	
	private DialCreerEtudiant dce;
	...
	/**
	* Constructeur de la classe DialModifierEtudiant.
	* @param fenetre
	...
	* @version sprint_2
	*/
	public DialModifierEtudiant(final FenetrePrincipal fenetre, final Etudiants etudiants){
		super(fenetre, "Modifier un etudiant", true);
		
////////////////////////////////Initialisation variables de la classe////////////////////////////////////////
		this.etudiants = etudiants;
		this.dce = new DialCreerEtudiant(fenetre, this.etudiants );
		...
		table.addMouseListener(new MouseAdapter() {
		    public void mousePressed(MouseEvent me) {
		        ...
		        if (me.getClickCount() == 2) {
		            ...
		            String nom = (String) modelTable.getValueAt(row, 2);
		            String prenom = (String) modelTable.getValueAt(row, 3);
		           
		            System.out.println(index + " : " + nom + " -> " + prenom);
		            
		            String[] values = {nom, prenom};//on récupere le nom et le titre de le ligne sélectionnée
		            
		            dce.update(values);// on envoie ces valeurs a la prochaine vue
					dce.setVisible(true);
					...
					if (dce.isBonneFin()){
						...
						if (reponse == 0){
							...
							String[] str2 = dce.getParam();
							
							str[0] = String.valueOf(index);
							str[1] = str2[0];
							str[2] = str2[1];
							
							etudiants.setEtudiant(str);
