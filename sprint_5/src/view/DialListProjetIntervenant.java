 ...
 * @version sprint3
 */
public class DialListProjetIntervenant extends JDialog implements ActionListener{
	...
	private DialAffecterIntervenant dai;
	...
	* @version sprint3
	*/
	public DialListProjetIntervenant(final FenetrePrincipal fenetre, Projets projets, Etudiants etudiants, Sujets sujets, Intervenants intervenants, Encadrer encadrer){
...
////////////////////////////////Initialisation JTable et model////////////////////////////////////////
		...
		this.dai = new DialAffecterIntervenant(this, intervenants, encadrer);
		...
		table.addMouseListener(new MouseAdapter() {
		    public void mousePressed(MouseEvent me) {
		        ...
		        if (me.getClickCount() == 2) {
		        	while(modelTable.getValueAt(row, 0).equals(" ") ){
		            	row--;
		            }
		        	if(!modelTable.getValueAt(row, 2).equals(" ") && !modelTable.getValueAt(row, 2).equals("")){
		        		dai.update(modelTable.getValueAt(row, 0), modelTable.getValueAt(row, 1), modelTable.getValueAt(row, 2), modelTable.getValueAt(row, 3), modelTable.getValueAt(row, 4), modelTable.getValueAt(row, 5), modelTable.getValueAt(row, 0));
			        	dai.setVisible(true);
			        	update();
		        	}else {
		        		JOptionPane.showMessageDialog(fenetre, "Veuillez affecter un sujet au projet pour pourvoir lui affecter des intervenants");
		        	}
		        }
		    }
...
////////////////////////////////Listener////////////////////////////////////////
	...
	*/
	...
	/**
	 * update objet intervenant
	 * @param intervenants objet intervenants
	 */
	public void updateItervenants(Intervenants intervenants){
		this.intervenants = intervenants;
	}
