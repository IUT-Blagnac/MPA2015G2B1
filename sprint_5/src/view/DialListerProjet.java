 ...
 * @version sprint_2
 */
public class DialListerProjet extends JDialog implements ActionListener{
	...
	* @version sprint_2
	*/
	public DialListerProjet(FenetrePrincipal fenetre, Projets projets, Etudiants etudiants, Sujets sujets, Intervenants intervenants){
