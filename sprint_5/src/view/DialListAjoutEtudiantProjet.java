 ...
 * @version sprint_2
 */
public class DialListAjoutEtudiantProjet extends JDialog implements ActionListener{
	...
	private DialAjouterEtudiantsProjet daep;
	...
	/**
	* Constructeur de la classe DialListAjoutEtudiantProjet.
	* @param fenetre
	...
	* @version sprint_2
	*/
	public DialListAjoutEtudiantProjet(FenetrePrincipal fenetre, Projets projets, Etudiants etudiants, Sujets sujets, Intervenants intervenants){
...
////////////////////////////////Initialisation variables de la classe////////////////////////////////////////
		...
		daep = new DialAjouterEtudiantsProjet(this, etudiants);
		...
		table.addMouseListener(new MouseAdapter() {
		    public void mousePressed(MouseEvent me) {
		        ...
		        if (me.getClickCount() == 2) {
		            ...
		            daep.update(modelTable.getValueAt(row, 0), modelTable.getValueAt(row, 1), modelTable.getValueAt(row, 2), modelTable.getValueAt(row, 0));
